# (C) Le Quoc Do - SE Group - TU Dresden
...
env.roledefs = {
    'masters': ['master'],
    'slaves': ['master', 'slaver1', 'slaver2', 'slaver3'],
}
...
urlHadoop = 'https://archive.apache.org/dist/hadoop/core/hadoop-2.7.0/hadoop-2.7.0.tar.gz'
urlSpark = 'https://archive.apache.org/dist/spark/spark-2.2.1/spark-2.2.1-bin-hadoop2.7.tgz'
...
@serial
def setupHadoop():
    execute(downloadHadoop)
    execute(configHadoop)

@serial
def setupSpark():
    execute(downloadSpark)
    execute(configSpark)
